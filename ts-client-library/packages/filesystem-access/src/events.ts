...
export class DownloadMetadataEvent extends CustomEvent<
  DownloadMetadataEventData
> {
...
export class DownloadStartedEvent extends CustomEvent<
  DownloadStartedEventData
> {
...
export class DownloadFinishedEvent extends CustomEvent<
  DownloadFinishedEventData
> {
...
export class DownloadProgressEvent extends CustomEvent<
...
export class FileSystemObjectDeleteEvent extends CustomEvent<
  FileSystemObjectDeleteEventData
> {
